...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { image: @coin.image, name: @coin.name, symbol: @coin.symbol } }, as: :json
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { image: @coin.image, name: @coin.name, symbol: @coin.symbol } }, as: :json
    assert_response 200
  end
